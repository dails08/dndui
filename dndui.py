    ...
    def __init__(self):
        ...
        class InitiativeGroup():
            def __init__(self, name = "Nobody", avatar = None, canvas = None, location = [0,0]):
                ...
                self.name_id = self.canvas.create_text(left_buffer + self.location[0] + avatar_size[0]/2,upper_buffer + self.location[1] + avatar_size[1] + 10, text = self.name, width = 200, font = self.font, justify = tk.CENTER)
